...
@interface ShoppingApp_iOS_Controls_KeyboardViewRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer {
}
	-(id) init;
@end
...
@interface ShoppingApp_iOS_Controls_CustomPickerRenderer : Xamarin_Forms_Platform_iOS_PickerRenderer {
}
	-(id) init;
@end
...
@interface ShoppingApp_iOS_Controls_CustomEntryRenderer : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end
